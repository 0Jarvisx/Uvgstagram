...
<body class="bg-gradient-to-r from-slate-400 via-gray-400 to-gray-600">
    <header class="p-5 border-b bg-gray-200 shadow">
        <div class="container mx-auto flex justify-between items-center">
            <h1 class="text-3xl font-black">
               @auth
               <a href="{{route('posts.inicio', ['user' => $user])}}" class="text-3xl font-black">UvgStagram</a>
               @endauth 
            </h1>
    ...
    <footer class="text-center p-5 text-gray-900 font-bold uppercase mt-10 bg-transparent">
